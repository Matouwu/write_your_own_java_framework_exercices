...
public final class JSONWriter {
    ...
    private static final class PropertyDescriptorClassValue extends ClassValue<PropertyDescriptor[]>{
        @Override
    ...
    private static final ClassValue<PropertyDescriptor[]> CLASS_VALUE = new PropertyDescriptorClassValue();
...
public final class JSONWriter {
    ...
    private static final class PropertyDescriptorClassValue extends ClassValue<List<Property>>{
        @Override
    ...
    private String toJSONObject(Object o){
        ...
        return propertyDescriptors.stream()
                .map(propertyDescriptor -> {
                    var value = Utils.invokeMethod(o,propertyDescriptor.getter);
                    return propertyDescriptor.prefix + toJSON(value);
                })
                .collect(Collectors.joining(", ","{","}"));
    }
